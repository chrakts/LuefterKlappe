...
enum{FLAP_STATUS_CLOSED, FLAP_STATUS_OPENED, FLAP_STATUS_OPENL1, FLAP_STATUS_OPENL2, FLAP_STATUS_AUTO, FLAP_STATUS_IS_CLOSED, FLAP_STATUS_IS_OPENED, FLAP_STATUS_CLOSING, FLAP_STATUS_OPENING, FLAP_STATUS_UNVALID = 255};

#define REPORT_BETWEEN_SENSORS 50
#define REPORT_BETWEEN_BLOCKS  3000
#define WAIT_AFTER_LAST_SENSOR  300

enum{TEMPREPORT=0,HUMIREPORT,ABSHUMIREPORT,DEWPOINTREPORT,L1SWELLREPORT,L2SWELLREPORT,L1HYSTREPORT,L2HYSTREPORT,FANACTUALSTATUSREPORT,FANSETSTATUSREPORT,FANMOMENTARYSTATUSREPORT,LASTREPORT};
